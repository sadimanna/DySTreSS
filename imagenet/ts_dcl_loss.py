...
class TSDCLLoss(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.min_temp = min_temp #erature
    ...
    def _loss(self, out0, out1, out0_all, out1_all):
        ...
        sim_00 = torch.einsum("nc,mc->nm", out0, out0_all) 
        sim_00 = sim_00 / self.get_temp(sim_00) #temperature
        sim_01 = torch.einsum("nc,mc->nm", out0, out1_all)
        sim_01 = sim_01 / self.get_temp(sim_01) #erature
