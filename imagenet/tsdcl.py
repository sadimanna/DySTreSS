...
class TSDCL(LightningModule):
    def __init__(self, batch_size_per_device: int, num_classes: int) -> None:
        ...
        self.criterion = TSDCLLoss(min_temp=0.1, max_temp=0.2, gather_distributed=True)
    ...
    def configure_optimizers(self):
        ...
        optimizer = LARS(
            [
                {"name": "tsdcl", "params": params},
                {
                    "name": "tsdcl_no_weight_decay",
